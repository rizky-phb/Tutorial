    ...
    <div class="container">
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <br>
                <p class="lead mx-5">Karena materi di Course ini simpel dan lengkap. Pokoknya bakal sesuai dengan
                    kebutuhanmu.</p>
                <br>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                ...
                <p class="lead mx-5">Kami mendukung seluruh anak muda di Indonesia untuk tetap bisa belajar, tanpa
